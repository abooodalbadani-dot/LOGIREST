...
exports.ROLE_CAPABILITIES = {
    adjustment: {
        ...
        approve: ['ADMIN', 'GM', 'APPROVER', 'INV_MGR', 'STORE_MGR', 'BRANCH_MGR'],
        reject: ['ADMIN', 'GM', 'APPROVER', 'INV_MGR', 'STORE_MGR', 'BRANCH_MGR'],
    ...
    stocktake: {
        ...
        approve: ['ADMIN', 'GM', 'APPROVER', 'INV_MGR', 'BRANCH_MGR'],
        reject: ['ADMIN', 'GM', 'APPROVER', 'INV_MGR', 'BRANCH_MGR'],
        post: ['ADMIN', 'INV_MGR', 'BRANCH_MGR'],
    ...
    kitchen_request: {
        create: ['ADMIN', 'INV_MGR', 'BRANCH_MGR', 'STORE_MGR', 'WH_KEEPER', 'KITCHEN_CHIEF'],
        submit: ['ADMIN', 'INV_MGR', 'BRANCH_MGR', 'STORE_MGR', 'WH_KEEPER', 'KITCHEN_CHIEF'],
