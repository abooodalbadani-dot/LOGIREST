...
const workflowMap: Record<BaseDocumentType, {
  ...
  'pr': {
    ...
    posted: [],
    locked: [PR_STATUS.SUBMITTED, PR_STATUS.APPROVED, PR_STATUS.REJECTED, PR_STATUS.CANCELLED, PR_STATUS.FULFILLED]
  },
  'po': {
    ...
    posted: [],
    locked: [PO_STATUS.SUBMITTED, PO_STATUS.PENDING_APPROVAL, PO_STATUS.APPROVED, PO_STATUS.REJECTED, PO_STATUS.FULFILLED, PO_STATUS.PARTIAL, PO_STATUS.CANCELLED]
  },
    'grn': {
  ...
  'transfer': {
    ...
    'adjustment': {
      ...
      locked: [ADJUSTMENT_STATUS.SUBMITTED, ADJUSTMENT_STATUS.APPROVED, ADJUSTMENT_STATUS.POSTED, ADJUSTMENT_STATUS.REJECTED, ADJUSTMENT_STATUS.CANCELLED, ADJUSTMENT_STATUS.VOIDED]
    },
    'stocktake': {
