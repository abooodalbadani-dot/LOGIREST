...
- Name: specs\procurement.spec.ts >> Procurement — Full Procure-to-Pay Workflow >> PR-04 | Convert APPROVED PR to PO creates a new Purchase Order
- Location: tests\e2e\specs\procurement.spec.ts:197:7
