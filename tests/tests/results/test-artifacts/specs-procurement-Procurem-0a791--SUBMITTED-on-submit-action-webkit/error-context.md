...
- Name: specs\procurement.spec.ts >> Procurement — Full Procure-to-Pay Workflow >> PR-02 | PR status transitions: DRAFT → SUBMITTED on submit action
- Location: tests\e2e\specs\procurement.spec.ts:112:7
