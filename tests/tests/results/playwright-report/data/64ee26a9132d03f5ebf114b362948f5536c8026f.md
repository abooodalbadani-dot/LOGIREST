...
- Name: specs\procurement.spec.ts >> Procurement — Full Procure-to-Pay Workflow >> GRN-NEG-02 | Void button absent for PROC_OFFICER on POSTED GRN
- Location: tests\e2e\specs\procurement.spec.ts:459:7
...
- banner:
  ...
  - link "User Profile":
    - /url: /en/profile
    - text: E2E Proc Officer PROC_OFFICER E
  - button "Logout"
- complementary:
  - navigation:
    - text: Dashboard
...
- main:
  ...
  - text: Read-Only View • GRN-2026-2656 Posted
  - button "Export"
  ...
  - paragraph: warehous...
  - paragraph: Notes
  - text: No Notes Posted - Read Only
  - table:
    - rowgroup:
  ...
  - paragraph: Posted
  - text: 22/06/2026 05:35:32 System
  - button "Back"
