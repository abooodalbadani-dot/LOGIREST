...
- main:
  - heading "#GRN-2026-4343" [level=1]
  - paragraph: Goods Received Notification Detail
  - button "Scanning Protocol Active"
  - text: Supplier
  - button "Select Supplier" [disabled]
  - text: Order Currency
  - button "Select Currency" [disabled]
  - text: Exchange Rate
  - textbox "Exchange Rate" [disabled]:
    - /placeholder: "1.00"
    - text: "1"
  ...
  - table:
    - rowgroup:
      - row "Name Qty Received Qty Lot Allocation":
        - columnheader "Name"
        - columnheader "Qty"
