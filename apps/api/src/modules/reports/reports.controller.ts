...
export class ReportsController {
  ...
  async exportMovements(
    ...
    const filename = 'stock-movements';
    const title = 'Stock Movements';
    ...
    while (hasMore) {
      const chunkResult = await this.reportsService.exportMovementsCursorChunk(
        warehouseId,
        cursor,
        500,
        { itemId, startDate, endDate, transactionType },
      );
      ...
      cursor = chunkResult.nextCursor || undefined;
