...
- Name: unsaved-changes.spec.ts >> Unsaved Changes Guard (SC-001, SC-003) >> Cancel button with skipGuard bypasses the dialog
- Location: apps\web\tests\e2e\unsaved-changes.spec.ts:91:3
