...
- Name: landed-cost.spec.ts >> Admin Role Assignment (US3) >> role assignment modal opens and shows user table
- Location: apps\web\tests\e2e\landed-cost.spec.ts:150:3
