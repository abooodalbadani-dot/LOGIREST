...
- Name: landed-cost.spec.ts >> Landed Cost Allocation (US1) >> wizard shows calculator icon when in development mode
- Location: apps\web\tests\e2e\landed-cost.spec.ts:13:3
...
Locator: locator('svg.lucide-calculator')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('svg.lucide-calculator')
