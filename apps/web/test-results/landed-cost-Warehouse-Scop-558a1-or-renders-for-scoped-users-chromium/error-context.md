...
- Name: landed-cost.spec.ts >> Warehouse Scope Selector (US2) >> scope selector renders for scoped users
- Location: apps\web\tests\e2e\landed-cost.spec.ts:129:3
...
Call log:
  ...
  - waiting for getByText(/warehouse/i)
