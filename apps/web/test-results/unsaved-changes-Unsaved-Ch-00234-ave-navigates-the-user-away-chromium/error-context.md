...
- Name: unsaved-changes.spec.ts >> Unsaved Changes Guard (SC-001, SC-003) >> Clicking "Discard & Leave" navigates the user away
- Location: apps\web\tests\e2e\unsaved-changes.spec.ts:73:3
