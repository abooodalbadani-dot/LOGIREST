...
export const UnsavedChangesDialog: React.FC<UnsavedChangesDialogProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="w-full inset-x-0 bottom-0 sm:bottom-auto mb-0 sm:mb-auto sm:w-[500px] sm:max-w-[500px] p-4 sm:p-6 bg-white dark:bg-card border border-gray-200 dark:border-gray-800 shadow-2xl rounded-t-lg sm:rounded-b-lg rounded-b-none text-foreground">
