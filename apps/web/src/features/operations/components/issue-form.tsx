...
export function IssueForm({ issue, id, isNew, onConflict }: IssueFormProps) {
 ...
 return (
  <div className="min-h-screen bg-card border border-border shadow-sm flex flex-col animate-in fade-in duration-200 pb-32">
     ...
     <div className="flex-1 px-6 lg:px-10 py-8">
      <div className="grid grid-cols-12 gap-8">
       <div className="col-span-12 lg:col-span-8 space-y-8">
        {!isDocLocked && (
         <div className="bg-card border border-border shadow-sm p-8 rounded-2xl shadow-sm relative overflow-hidden group transition-all hover:shadow-md">
