    ...
    <div className="px-8 pt-8">
     <div className="bg-card border border-border shadow-sm p-8 rounded-2xl relative shadow-2xl shadow-black/5">
      ...
      <DocumentLockWrapper isLocked={isLocked}>
       ...
       <div className="pt-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 bg-card border border-border shadow-sm/20 p-6 rounded-2xl">
