...
export function PurchaseOrderLineItems({
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="w-full rounded-2xl bg-surface-container-low/20 border border-white/5 backdrop-blur-md shadow-inner overflow-hidden">
        <div
          ref={parentRef}
            ...
            <FormItem className="space-y-0 w-full">
              <FormControl>
                <Input
                  ...
                  min="1"
                  disabled={isLocked}
                  className="bg-surface-container-low border border-white/10 font-mono h-11 rounded-xl focus-visible:ring-operational-cyan/30 text-body-sm font-bold text-center transition-all group-hover:bg-surface-container-high"
                  dir="ltr"
                  {...inputField}
