        ...
        <div className="flex gap-4">
          <PermissionGate action="create" resource="procurement_pr">
            <Link href="/purchase-requests/new" className="contents">
              <Button variant="outline" className="border-none bg-surface-container-low rounded-xl h-14 px-8 font-semibold uppercase text-label-xs hover:bg-operational-cyan hover:text-black transition-all">
                  ...
                  <div key={i} className="px-8 py-6 flex items-center justify-between hover:bg-surface-container-high/40 transition-all duration-140 ease-industrial cursor-pointer group">
                    ...
                    <div className="flex items-center gap-4">
                      <PermissionGate action="approve" resource="procurement_pr">
                        <Button variant="ghost" className="rounded-2xl border-none bg-surface-container-low h-12 px-6 font-semibold uppercase text-label-xs hover:bg-operational-cyan hover:text-black transition-all">
                          {tc('actions.review')}
                        </Button>
                      </PermissionGate>
                    </div>
            ...
            <div className="p-8 pt-2 space-y-6">
              ...
              <PermissionGate action="view" resource="master_data_suppliers">
                <Link href="/master-data/suppliers" className="w-full">
                  <Button className="w-full bg-surface-container-high hover:bg-operational-cyan hover:text-black border-none rounded-2xl text-label-xs font-semibold uppercase h-14 mt-6 transition-all hover:scale-[0.98] hover:brightness-110 active:scale-95">
