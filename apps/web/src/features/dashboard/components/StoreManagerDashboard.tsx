                    ...
                    <div className="flex items-center gap-8">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-4">
                          ...
                          <Badge className={`rounded-lg text-label-xxs font-semibold uppercase px-2.5 py-1 border-none ${ job.priority.toLowerCase() === 'high' || job.priority.toLowerCase() === 'urgent' ? 'bg-status-error text-white animate-pulse' : 'bg-surface-container-high text-muted-foreground/60' }`}>
