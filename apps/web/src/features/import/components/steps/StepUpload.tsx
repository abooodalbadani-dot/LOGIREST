...
export function StepUpload({ wizard, locale }: StepUploadProps) {
 ...
 >
 <div className="w-20 h-20 rounded-2xl bg-card border border-border shadow-sm flex items-center justify-center transition-all group-hover:scale-110 group-hover:bg-cyan-500/10 group-hover:text-cyan-500">
 ...
 <div className="bg-card border border-border shadow-sm/50 rounded-2xl p-8 flex items-center justify-between animate-in zoom-in-95 duration-300">
 ...
 className="w-full sm:w-auto px-10 h-14 rounded-xl border-muted-foreground/10 bg-card border border-border shadow-sm hover:bg-surface-container-high transition-all active:scale-95 group"
 >
 ...
 file ? "bg-brand-gold hover:bg-brand-gold-hover text-white transition-colors shadow-neon-sm" : "opacity-50 grayscale"
 )}
 >
