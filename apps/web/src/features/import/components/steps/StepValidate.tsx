...
export function StepValidate({ wizard, locale }: StepValidateProps) {
 ...
 <div className="relative w-32 h-32 rounded-2xl bg-card border border-border shadow-sm flex items-center justify-center shadow-2xl">
 <Database className="w-16 h-16 text-cyan-500" />
 <div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-xl bg-background shadow-sm flex items-center justify-center">
