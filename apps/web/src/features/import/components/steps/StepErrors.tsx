...
export function StepErrors({ wizard, locale }: StepErrorsProps) {
 ...
 {/* Error Table */}
 <div className="rounded-2xl overflow-hidden bg-card border border-border shadow-sm/30 shadow-inner">
 <div className="overflow-x-auto">
 <table className="w-full text-start">
 <thead>
 <tr className="bg-card border border-border shadow-sm/50">
 ...
 <tr key={i} className="group hover:bg-card/[0.02] transition-colors">
 ...
 <div className="p-4 text-center bg-card border border-border shadow-sm/20">
