          ...
          {!isReadOnly && (
            <FormFooter>
              ...
              <button
                type="button"
                onClick={onSubmit}
                className="bg-operational-cyan hover:bg-operational-cyan/90 text-white h-10 px-6 rounded-md transition-colors disabled:opacity-50 shadow-sm shadow-operational-cyan/20"
