...
<<<<<<< HEAD:src/app/[locale]/(app)/master-data/units-of-measure/UoMListClient.tsx
...
>>>>>>> 002-frontend-baseline:apps/web/src/app/[locale]/(app)/master-data/units-of-measure/UoMListClient.tsx
      ...
      <DataTable 
        ...
        emptyState={
          <EmptyState 
            ...
            description={tu('empty.description')}
            action={
              <PermissionGate action="create" resource="master_data">
                <Link href={`/master-data/units-of-measure/new`}>
