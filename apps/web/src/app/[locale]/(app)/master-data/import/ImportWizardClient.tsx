...
export function ImportWizardClient({ type, locale }: ImportWizardClientProps) {
 ...
 return (
  <div className="flex flex-col gap-6 p-6">
   ...
   {/* Stepper */}
   <div className="grid grid-cols-4 gap-4 p-4 bg-surface-container-low rounded-3xl border border-primary/5">
    {steps.map((step, idx) => {
     ...
     return (
      <div 
       ...
       className={cn(
        ...
        isActive ? "bg-cyan-500/10 shadow-lg shadow-cyan-500/5 ring-1 ring-cyan-500/20" : "opacity-40"
       )}
      >
       <div className={cn(
