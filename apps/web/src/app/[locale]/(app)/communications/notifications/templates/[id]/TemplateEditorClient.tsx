    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
     ...
     <div className="lg:col-span-7 space-y-6">
      ...
      <motion.div
       ...
       className="p-6 rounded-none bg-card border border-border shadow-sm border border-white/10 space-y-4 relative overflow-hidden"
      >
       <div className="flex items-center justify-between border-b border-white/10 pb-3">
        ...
        <span className="text-[9px] font-mono bg-card/5 border border-white/10 px-2 py-0.5 text-muted-foreground uppercase tracking-widest">
      ...
      <motion.div
       ...
       animate={{ opacity: 1, y: 0 }}
       className="p-6 md:p-8 rounded-[2rem] bg-card border border-border shadow-sm/60 backdrop-blur-lg border border-white/10 shadow-2xl space-y-6 relative overflow-hidden group hover:border-operational-cyan/20 transition-all duration-300"
      >
       ...
       <div className="grid gap-3">
        <Label htmlFor="subject-ar" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/80 ms-1">
         {t('subject_ar')}
        </Label>
        <div className="relative">
         <Textarea
          ...
          className="min-h-[60px] py-3.5 bg-card border border-border shadow-sm rounded-2xl px-5 focus-visible:ring-2 focus-visible:ring-operational-cyan focus-visible:border-operational-cyan transition-all text-sm shadow-inner focus:shadow-[0_0_20px_rgba(var(--operational-cyan-rgb),0.1)]"
         />
        </div>
       </div>

       <div className="grid gap-3">
        <Label htmlFor="body-ar" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/80 ms-1">
         {t('body_ar')}
        </Label>
        <div className="relative">
         <Textarea
      ...
      >
       ...
       <div className="grid gap-3">
        <Label htmlFor="subject-en" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/80 ms-1">
         {t('subject_en')}
        </Label>
        <div className="relative">
         <Input
          ...
          className="h-14 font-semibold bg-card border border-border shadow-sm rounded-2xl px-5 focus-visible:ring-2 focus-visible:ring-operational-cyan focus-visible:border-operational-cyan transition-all text-sm shadow-inner focus:shadow-[0_0_20px_rgba(var(--operational-cyan-rgb),0.1)]"
         />
        </div>
       </div>

       <div className="grid gap-3">
        <Label htmlFor="body-en" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/80 ms-1">
         {t('body_en')}
        </Label>
        <div className="relative">
         <Textarea
     ...
     <div className="lg:col-span-5 lg:sticky lg:top-8 space-y-6">
      ...
      <motion.div
       ...
       className="rounded-[2.5rem] bg-card border border-border shadow-sm/60 backdrop-blur-lg border border-white/10 shadow-2xl overflow-hidden"
      >
       ...
       <div className="px-6 py-4 bg-surface-container/60 border-b border-white/10 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
         ...
         <div className="flex bg-card border border-border shadow-sm/50 rounded-lg p-0.5 border border-outline-low backdrop-blur-sm scale-90">
          <button
           type="button"
       ...
       <div className="p-6 bg-[url('/grid.svg')] bg-center bg-fixed opacity-95 min-h-[460px] flex flex-col justify-between min-w-0">
        ...
        <div className="mt-4 p-4 rounded-2xl bg-card border border-border shadow-sm/80 border border-white/5 flex items-start gap-3 shadow-md">
