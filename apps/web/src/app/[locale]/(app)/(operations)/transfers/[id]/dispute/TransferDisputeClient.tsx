    ...
    <div className="p-8 max-w-[1600px] mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div 
            className="border-2 border-dashed border-outline-low/50 bg-surface-container-lowest hover:bg-surface-container-low/50 transition-colors rounded-xl p-10 flex flex-col items-center justify-center cursor-pointer"
            onDrop={handleDrop}
          ...
          {evidenceFiles.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
              {evidenceFiles.map((f, i) => (
                <div key={i} className="flex items-center gap-4 p-4 bg-surface-container-lowest border border-outline-low rounded-lg shadow-sm">
