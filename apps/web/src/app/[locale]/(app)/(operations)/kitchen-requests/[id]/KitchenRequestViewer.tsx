...
export function KitchenRequestViewer({ request, locale, actions }: KitchenRequestViewerProps) {
    ...
    const showRelatedIssueBlock = resolvedIssues.length > 0;
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-1">
                                    ...
                                    <span className="text-xs font-bold uppercase text-operational-cyan flex items-center gap-1.5">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        <div className="bg-card border border-border shadow-sm p-4 sm:p-6 md:p-8 rounded-lg border-surface-container-high/20">
                            <div className={cn(
                                ...
                                showRelatedIssueBlock ? "md:grid-cols-4" : "md:grid-cols-3"
                            )}>
                                <div className="space-y-1">
                                    <span className="text-label-sm font-bold uppercase text-operational-cyan flex items-center gap-2">
                                ...
                                {showRelatedIssueBlock && (
                                    <div className="space-y-1">
                                        <span className="text-label-sm font-bold uppercase text-operational-cyan flex items-center gap-2">
                                            ...
                                            {locale === 'ar' ? 'سند الصرف المرتبط' : 'Related Issue Document'}
                                        </span>
                                        <div className="flex flex-col gap-1 min-w-0">
                                            {resolvedIssues.map((issue) => (
                                                <Link
                                                    ...
                                                    className="text-body-md font-bold font-mono text-operational-cyan hover:underline truncate"
                                                >
                                                    {issue.label}
                                                </Link>
                                            ))}
                                ...
                                {request.notes && (
                                    <div className="col-span-2 md:col-span-3 pt-4 border-t border-surface-container-high/50">
                                        <div className="flex flex-col gap-1.5 p-3 sm:p-4 bg-surface-container-lowest rounded-xl">
                                            <span className="text-label-sm font-bold uppercase text-operational-cyan flex items-center gap-1.5">
