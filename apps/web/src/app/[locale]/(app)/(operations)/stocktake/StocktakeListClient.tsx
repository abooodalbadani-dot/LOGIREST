                ...
                >
                  ...
                  <div className="flex justify-between items-start border-b border-brand-gold/50 dark:border-brand-gold/50 pb-3">
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="text-[10px] text-brand-gold font-bold uppercase tracking-widest mt-1">
                        Operational Audit
                      </span>
                    </div>
                    {/* Status Badge */}
                  ...
                  <div className="flex justify-between items-center gap-2">
                    <div className="flex items-center gap-2 min-w-0">
                      <div className="p-1.5 bg-gray-50 dark:bg-gray-800 rounded-md border border-brand-gold/50 dark:border-brand-gold/50 shrink-0">
                    ...
                    <div dir="ltr" className="shrink-0">
                      <ClientOnlyTime
                        ...
                        mode="datetime"
                        locale={locale as 'ar' | 'en'}
                        className="text-[10px] font-medium text-brand-gold"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 pt-3 border-t border-gray-50 dark:border-gray-800/50">
                    <div className="flex flex-col gap-1 w-full">
                      <div className="flex justify-between text-[10px] font-bold text-brand-gold">
