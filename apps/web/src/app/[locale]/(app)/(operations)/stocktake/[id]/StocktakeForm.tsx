...
<<<<<<< HEAD:src/app/[locale]/(app)/(operations)/stocktake/[id]/StocktakeForm.tsx
...
>>>>>>> 002-frontend-baseline:apps/web/src/app/[locale]/(app)/(operations)/stocktake/[id]/StocktakeForm.tsx
  const { user } = useAuth();
