...
export function StocktakeViewer({ session, locale, actions }: StocktakeViewerProps) {
  ...
  return (
    <div className="min-h-screen bg-surface-container-low pb-12 animate-in fade-in duration-500 print:bg-white print:pb-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 space-y-6">
        ...
        {/* Summary Table */}
        <Card className="bg-surface-container-lowest border-none shadow-sm rounded-2xl overflow-hidden print:bg-white print:shadow-none print:rounded-none">
        ...
        {/* Status Timeline */}
        <div className="bg-surface-container-lowest p-8 rounded-2xl shadow-sm transition-all hover:bg-surface-container-low/50 print-hidden">
