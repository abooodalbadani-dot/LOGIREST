     ...
     >
      <div className="flex items-center gap-4">
       ...
       <PostConfirmDialog
        ...
        trigger={
         <Button disabled={!canSubmit || submitVariance.isPending} className="bg-brand-gold hover:bg-brand-gold-hover text-white transition-colors shadow-sm shadow-primary/20">
