...
export function FrozenItemsClient() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8">
      ...
      <div className="p-5 bg-operational-amber/5 border border-operational-amber/20 rounded-[2rem] flex flex-col md:flex-row gap-4 items-start md:items-center">
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-surface-highest/10 text-muted-foreground text-[10px] font-bold uppercase tracking-wider">
                    <th className="py-4 px-4">Warehouse</th>
                    <th className="py-4 px-4">SKU / Item</th>
                    <th className="py-4 px-4 text-right">On Hand</th>
                    <th className="py-4 px-4 text-right">Allocated</th>
                    ...
                    {data.map((item) => {
                      ...
                      return (
                        <motion.tr
                          ...
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                          className="hover:bg-surface-container-high/50 transition-colors text-xs"
                        >
