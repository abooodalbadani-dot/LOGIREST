    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
     ...
     <div className="lg:col-span-4 space-y-6">
      ...
      <motion.div 
       ...
       className="p-8 rounded-[2.5rem] bg-card border border-border shadow-sm/60 backdrop-blur-lg border border-white/10 space-y-6 relative overflow-hidden group shadow-2xl transition-all duration-300 hover:border-operational-cyan/20"
      >
       ...
       <div className="grid grid-cols-2 gap-3 pt-2 text-[10px] uppercase font-bold text-muted-foreground/50 tracking-wider">
        <div className="p-3 bg-card border border-border shadow-sm/50 rounded-xl border border-white/5">
      ...
      <motion.div 
       ...
       className="p-8 rounded-[2.5rem] bg-card border border-border shadow-sm/40 border border-white/5 relative h-48 overflow-hidden group shadow-sm backdrop-blur-sm"
      >
       ...
       <div className="relative h-full flex flex-col justify-end min-w-0">
     ...
     <div className="lg:col-span-8 space-y-6">
      ...
      >
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-3">
         ...
         <div className="relative group">
          <Input
           {...register('systemName')}
           className={cn(
            "h-14 font-bold bg-card border border-border shadow-sm/80 border border-outline-low rounded-2xl px-5 focus-visible:ring-operational-cyan focus-visible:border-operational-cyan transition-all text-sm shadow-inner group-hover:border-white/20 focus:shadow-[0_0_20px_rgba(var(--operational-cyan-rgb),0.1)]",
            errors.systemName ? "border-status-error focus-visible:ring-status-error" : ""
           )}
          />
         </div>
         {errors.systemName && (
          <p className="text-[10px] font-bold text-status-error uppercase ms-1 flex items-center gap-1.5 animate-pulse">
        ...
        <div className="space-y-3">
         ...
         >
          <SelectTrigger className="h-14 bg-card border border-border shadow-sm/80 border border-outline-low rounded-2xl px-5 font-bold transition-all hover:border-operational-cyan/20 text-sm focus:border-operational-cyan focus:ring-1 focus:ring-operational-cyan">
           <SelectValue placeholder={t('select_language')} />
          </SelectTrigger>
          <SelectContent className="bg-card border border-border shadow-sm border-outline-low rounded-xl backdrop-blur-xl">
        ...
        <div className="space-y-3 md:col-span-2">
         ...
         >
          <SelectTrigger className="h-14 bg-card border border-border shadow-sm/80 border border-outline-low rounded-2xl px-5 font-bold transition-all hover:border-operational-cyan/20 text-sm focus:border-operational-cyan focus:ring-1 focus:ring-operational-cyan disabled:opacity-50 disabled:cursor-not-allowed">
           <SelectValue placeholder={t('select_currency')} />
          </SelectTrigger>
          <SelectContent className="bg-card border border-border shadow-sm border border-outline-low rounded-xl max-h-60 backdrop-blur-xl">
           {loadingCurrencies ? (
      ...
      <div className="flex items-center justify-end gap-4 p-4 rounded-3xl bg-card border border-border shadow-sm/40 backdrop-blur-md border border-white/5 shadow-sm">
       <motion.div
