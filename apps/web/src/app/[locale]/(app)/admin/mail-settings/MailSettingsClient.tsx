      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <motion.div
            ...
            className="p-6 rounded-[2rem] bg-card border border-border shadow-sm border border-white/5 space-y-6 relative overflow-hidden group shadow-sm"
          >
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-end min-w-0">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-operational-cyan">
                {t('encryption_card_title')}
              </h3>
              <p className="text-xs text-operational-cyan mt-2 leading-relaxed">
                {t('ssl_tls_desc')}
              </p>
            </div>
          </motion.div>
        ...
        <div className="lg:col-span-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <div className="p-8 md:p-10 rounded-[2.5rem] bg-card border border-border shadow-sm border border-white/5 shadow-sm space-y-12">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  <div className="md:col-span-8 space-y-2.5">
                    <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ms-1">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        dir="ltr"
                        className="pl-12 h-14 font-bold bg-card border border-border shadow-sm border-outline-low rounded-2xl focus:ring-operational-cyan focus:border-operational-cyan transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        dir="ltr"
                        className="pl-12 pr-12 h-14 font-bold bg-card border border-border shadow-sm border-outline-low rounded-2xl focus:ring-operational-cyan focus:border-operational-cyan transition-all"
                      />
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                        className="absolute end-4 top-1/2 -translate-y-1/2 text-muted-foreground/40 hover:text-operational-cyan transition-colors"
                      >
                ...
                {/* Encryption Toggle */}
                <div className="pt-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-6 rounded-3xl bg-surface-container-highest/20 border border-white/5 gap-6 min-w-0">
                    <div className="flex items-center gap-4">
                    ...
                    <div className="w-full md:w-64">
                      ...
                      >
                        <SelectTrigger className="h-12 bg-card border border-border shadow-sm border-outline-low rounded-xl font-bold">
                          <SelectValue />
                        </SelectTrigger>
