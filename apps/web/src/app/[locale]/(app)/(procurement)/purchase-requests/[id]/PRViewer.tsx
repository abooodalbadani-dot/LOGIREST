            ...
            <div className="space-y-6 print:space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {document.notes && (
                    <div className="flex flex-col gap-1 min-w-0 col-span-2 pt-2 border-t border-border/50">
                      ...
                      <span className="text-sm font-bold text-foreground break-words">{document.notes}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="hidden md:grid bg-card p-4 rounded-md border grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="flex flex-col gap-1 items-start">
                  ...
                  <span className="text-title-sm font-bold text-foreground line-clamp-2">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-center gap-4 px-2">
                  ...
                  <div>
                    <h3 className="text-label-xs font-semibold uppercase text-muted-foreground/80">
                      {tc('items')}
                    </h3>
                    <p className="text-label-xxs font-semibold text-muted-foreground/50 uppercase mt-0.5">
                      {t('specification')}
                    </p>
                  </div>
                </div>
