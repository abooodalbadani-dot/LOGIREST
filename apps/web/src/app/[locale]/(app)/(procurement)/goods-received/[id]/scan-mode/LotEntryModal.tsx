...
export function LotEntryModal({
 ...
 <DialogContent className="w-full inset-x-0 bottom-0 sm:bottom-auto mb-0 sm:mb-auto sm:max-w-[425px] bg-surface-container-high border-none rounded-t-[2rem] sm:rounded-b-[2rem] rounded-b-none shadow-2xl p-4 sm:p-8">
 <DialogHeader>
