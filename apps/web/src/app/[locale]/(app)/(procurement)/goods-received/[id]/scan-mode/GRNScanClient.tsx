  ...
  <div className="min-w-0 gap-6 flex-1 flex-col flex pb-20 space-y-6 w-full">
   ...
   <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
    <div className="lg:col-span-5 space-y-6">
     <Card className="p-10 bg-card border border-border shadow-sm border-none shadow-none rounded-sm flex flex-col items-center justify-center min-h-[400px] min-w-0">
    ...
    <div className="lg:col-span-7 space-y-4">
     <div className="flex items-center justify-between px-2">
      ...
      <Badge variant="outline" className="bg-card/5 border-none font-semibold text-label-xs">
       {grn.items.length} {common("items").toUpperCase()}
      </Badge>
     </div>

     <Card className="overflow-hidden bg-card border border-border shadow-sm border-none shadow-none rounded-sm">
      <Table>
        ...
        {grn.items.length === 0 && (
         <TableRow>
          <TableCell colSpan={3} className="h-40 text-center">
           <div className="flex flex-col items-center gap-2 text-muted-foreground/30 min-w-0">
