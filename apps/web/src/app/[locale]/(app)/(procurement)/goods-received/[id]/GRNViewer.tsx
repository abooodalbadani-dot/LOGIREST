      ...
      <div className="max-w-[1400px] mx-auto space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-card border border-border shadow-sm p-6 rounded-2xl shadow-sm flex flex-col gap-1 group relative overflow-hidden border border-surface-variant/5">
            ...
            <p className="text-xs font-bold uppercase text-primary group-hover:text-primary transition-colors">{tc('order_currency')}</p>
          ...
          <div className="bg-card border border-border shadow-sm p-6 rounded-2xl shadow-sm flex flex-col gap-1 group relative overflow-hidden border border-surface-variant/5">
            ...
            <p className="text-xs font-bold uppercase text-primary group-hover:text-primary transition-colors">{tc('ref_document')}</p>
            <div className="mt-2">
              {document?.poNumber ? (
          ...
          <div className="bg-card border border-border shadow-sm p-6 rounded-2xl shadow-sm flex flex-col gap-1 group relative overflow-hidden border border-surface-variant/5">
            ...
            <p className="text-xs font-bold uppercase text-primary group-hover:text-primary transition-colors">{tc('warehouse')}</p>
          ...
          <div className="col-span-full bg-card border border-border shadow-sm p-6 rounded-2xl shadow-sm flex flex-col gap-1 group relative overflow-hidden border border-surface-variant/5">
            ...
            <p className="text-xs font-bold uppercase text-primary group-hover:text-primary transition-colors">{tc('notes')}</p>
            <div className="mt-2 p-4 bg-card border border-border shadow-sm rounded-xl text-body-md font-bold text-foreground/70 not-italic">
        ...
        {/* Financial Summary */}
        <div className="flex flex-col md:flex-row justify-end items-start md:items-center gap-8 pt-6">
          ...
          <Card className="bg-card border border-border shadow-sm p-8 rounded-2xl shadow-xl relative overflow-hidden min-w-[340px] group border border-surface-variant/5">
            ...
            <div className="space-y-6 relative z-10">
              <div className="flex justify-between items-baseline gap-10">
                <p className="text-xs font-bold uppercase text-primary group-hover:text-primary transition-colors">{t('receipt_total', { currency: document?.currencyCode || 'USD' })}</p>
              ...
              <div className="flex justify-between items-center gap-10">
                <p className="text-xs font-bold uppercase text-primary">{t('base_value', { currency: baseCurrency })}</p>
