...
cell: () => (
 ...
 <div className="flex items-center gap-3">
 <span className="text-label-xs font-semibold text-muted-foreground/60/40 uppercase">{t('filter_category')}</span>
 <Select value="all">
 ...
 <div className="flex items-center gap-3">
 <span className="text-label-xs font-semibold text-muted-foreground/60/40 uppercase">{t('filter_status')}</span>
 <Select value="all">
 <SelectTrigger className="w-48 bg-surface-container-low border-none rounded-xl h-10 text-label-xs font-semibold uppercase">
 <SelectValue placeholder={t('filter_all')} />
 </SelectTrigger>
 ...
 <span className="text-label-xs font-semibold uppercase text-muted-foreground/60/40">{t('quick_actions')}</span>
 </div>
