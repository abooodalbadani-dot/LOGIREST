...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="bg-[#050505] text-[#f1f5f9] font-sans antialiased">
          ...
          <div className="flex flex-col items-stretch space-y-6 max-w-md w-full">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 min-h-[40px] px-4 py-2 border border-white/10 text-slate-300 hover:bg-white/5 active:scale-95 transition-all rounded font-mono text-xs uppercase tracking-wider font-bold"
              >
                Dashboard
              </button>
            </div>
