...
export const PERMISSION_MATRIX: Partial<Record<UserRole, Partial<Record<ResourceType, ActionType[]>>>> = {
 ...
 procurement_grn: ['view', 'create', 'edit', 'post', 'export'],
   ...
   INV_MGR: {
    ...
    inventory: ['view', 'export'],
    stocktake: ['view', 'create', 'edit', 'post', 'export', 'submit', 'review_variance', 'close'],
    adjustment: ['view', 'create', 'edit', 'post', 'export'],
    transfer: ['view', 'create', 'edit', 'post', 'export', 'ship', 'receive'],
    issue: ['view', 'create', 'edit', 'post', 'export'],
    inventory_balance: ['view', 'export'],
    inventory_lots: ['view', 'create', 'edit', 'delete', 'export', 'update'],
    inventory_movements: ['view', 'export'],
    operations_stocktake: ['view', 'create', 'edit', 'post', 'export', 'submit', 'review_variance', 'close'],
    operations_adjustments: ['view', 'create', 'edit', 'post', 'export'],
    operations_transfers: ['view', 'create', 'edit', 'post', 'export', 'ship', 'receive'],
    operations_issues: ['view', 'create', 'edit', 'post', 'export'],
    kitchen_requests: ['view', 'fulfill', 'export'],
    operations_kitchen_requests: ['view', 'fulfill', 'export'],
    reports: ['view', 'export'],
    master_data: ['view'],
    master_data_items: ['view', 'create', 'edit', 'delete', 'update'],
    master_data_categories: ['view', 'create', 'edit', 'delete', 'update'],
    master_data_units_of_measure: ['view', 'create', 'edit', 'delete', 'update'],
    master_data_barcodes: ['view', 'create', 'edit', 'delete', 'update'],
 ...
 master_data_fx_rates: ['view'],
  ...
  PROC_MGR: {
    ...
    master_data: ['view'],
    master_data_items: ['view'],
    master_data_suppliers: ['view', 'create', 'edit', 'delete', 'update'],
    master_data_fx_rates: ['view', 'create', 'edit', 'delete', 'update'],
    procurement_grn: ['view', 'create', 'edit', 'post', 'export'],
    procurement_pr: ['view', 'create', 'edit', 'approve', 'reject', 'export', 'submit'],
