...
export const PERMISSION_MATRIX: Partial<Record<UserRole, Partial<Record<ResourceType, ActionType[]>>>> = {
 ...
 /** @see PERMISSION_MATRIX for the original source; these entries extend it with new roles. */
 const BRANCH_MGR_PERMISSIONS: Partial<Record<ResourceType, ActionType[]>> = {
   grn: ['view', 'create', 'edit', 'post', 'export'],
 ...
 const PROC_MGR_PERMISSIONS: Partial<Record<ResourceType, ActionType[]>> = {
   grn: ['view', 'create', 'edit', 'post', 'export'],
   pr: ['view', 'create', 'edit', 'approve', 'reject', 'export', 'submit'],
 ...
 // Merge new role permissions into the main matrix export
 (PERMISSION_MATRIX as Record<string, Partial<Record<ResourceType, ActionType[]>>>)['BRANCH_MGR'] = BRANCH_MGR_PERMISSIONS;
 (PERMISSION_MATRIX as Record<string, Partial<Record<ResourceType, ActionType[]>>>)['PROC_MGR'] = PROC_MGR_PERMISSIONS;
