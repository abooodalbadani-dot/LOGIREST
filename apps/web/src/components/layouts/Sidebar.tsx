...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        { key: 'items', href: '/master-data/items', resource: 'master_data_items', labelKey: 'items', icon: Package },
        { key: 'categories', href: '/master-data/categories', resource: 'master_data_categories', labelKey: 'categories', icon: Layers, warehouseOnly: true },
        { key: 'warehouses', href: '/master-data/warehouses', resource: 'master_data', labelKey: 'warehouses', icon: Warehouse, warehouseOnly: true },
        { key: 'uom', href: '/master-data/units-of-measure', resource: 'master_data', labelKey: 'uom', icon: Ruler, warehouseOnly: true },
        { key: 'suppliers', href: '/master-data/suppliers', resource: 'master_data_suppliers', labelKey: 'suppliers', icon: Building2, warehouseOnly: true },
        { key: 'departments', href: '/master-data/departments', resource: 'master_data_departments', labelKey: 'departments', icon: Building2, warehouseOnly: true },
        { key: 'barcodes', href: '/master-data/barcodes', resource: 'master_data', labelKey: 'barcodes', icon: Barcode, warehouseOnly: true },
        { key: 'barcode_mapping', href: '/master-data/barcodes/mapping', resource: 'barcode_mapping', labelKey: 'barcode_mapping', icon: Barcode, warehouseOnly: true },
        { key: 'currencies', href: '/master-data/currencies', resource: 'master_data', labelKey: 'currencies', icon: Coins, warehouseOnly: true },
        { key: 'fx_rates', href: '/master-data/fx-rates', resource: 'master_data_fx_rates', labelKey: 'fx_rates', icon: TrendingUp, warehouseOnly: true },
        { key: 'branches', href: '/master-data/branches', resource: 'master_data', labelKey: 'branches', icon: Building2, warehouseOnly: true },
        { key: 'import', href: '/master-data/import', resource: 'master_data', labelKey: 'import', icon: Database, warehouseOnly: true },
      ]
    },
    {
      key: 'reports_group',
