...
export function DocumentLock({ 
  ...
  return (
    <div className={cn("relative group/lock", className)}>
      {showBadge && (
        <div className="absolute top-4 right-4 z-20 flex items-center gap-2 px-3 py-1.5 bg-surface-container-highest/80 backdrop-blur-md border border-outline-low rounded-full shadow-lg animate-in fade-in slide-in-from-top-2 duration-500">
