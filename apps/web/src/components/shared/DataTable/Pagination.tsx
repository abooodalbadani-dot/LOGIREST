...
export function Pagination({ page, totalPages, onPageChange }: PaginationProps) {
 ...
 disabled={isFirst}
 className="p-2 bg-card border border-border shadow-sm hover:bg-surface-container text-foreground disabled:opacity-30 disabled:pointer-events-none rounded-2xl transition-all border-none group hover:scale-[0.98] active:scale-95"
 ...
 <div className="h-9 px-4 flex items-center bg-card border border-border shadow-sm/40 backdrop-blur-md rounded-2xl text-label-xs font-semibold uppercase text-operational-cyan">
