             ...
             <td className="block w-full p-0 border-none bg-transparent md:hidden">
              ...
              {mobileLayoutPattern === 'adjustment-form' ? (
               <div className="flex flex-col gap-3 p-3 bg-white dark:bg-[#1A2234] border-x border-b border-gray-200 dark:border-transparent items-center w-full rounded-b-xl">
                ...
                {extraColumns[0] && (
                 <div className="flex items-center justify-between gap-2 w-full h-8">
                  <label className="text-[9px] text-gray-600 dark:text-gray-500 uppercase tracking-widest shrink-0">{extraColumns[0].header}</label>
                  <div className="w-auto flex-1 flex justify-end">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                 ...
                 {extraColumns[1] && (
                  <div className="flex items-center justify-between gap-2 w-full h-8">
                   <label className="text-[9px] text-gray-600 dark:text-gray-500 uppercase tracking-widest shrink-0">{extraColumns[1].header}</label>
                   <div className="w-auto flex-1 flex justify-end">
                 ...
                 {extraColumns[2] && (
                  <div className="flex items-center justify-between gap-2 w-full h-8">
                   <label className="text-[9px] text-gray-600 dark:text-gray-500 uppercase tracking-widest shrink-0">{extraColumns[2].header}</label>
                   <div className="w-auto flex-1 flex justify-end">
