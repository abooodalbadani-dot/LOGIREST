   ...
   <div className="p-8 max-w-[1000px] mx-auto space-y-10 animate-in fade-in duration-200">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
     <div className="lg:col-span-2 space-y-8">
      {/* Main Form Section */}
      <Card className="bg-card border border-border shadow-sm border-none overflow-hidden p-8 space-y-8">
     ...
     <div className="space-y-8">
      {/* Sidebar Card */}
      <Card className="bg-card border border-border shadow-sm border-none overflow-hidden p-8 space-y-6">
 ...
 return (
  <div className="space-y-10 animate-in fade-in duration-200 p-8">
   ...
   <div className="space-y-6">
    <Card className="p-8 space-y-6 border-none bg-card border border-border shadow-sm">
    ...
    <Card className="overflow-hidden border-none bg-card border border-border shadow-sm">
