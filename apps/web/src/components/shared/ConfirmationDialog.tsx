...
export function ConfirmationDialog({
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="sm:max-w-[600px] w-[calc(100vw-2rem)] border-none ambient-shadow p-10 bg-surface-container-lowest rounded-[2rem]">
        ...
        <AlertDialogFooter className="gap-4 mt-8">
          ...
          <Button
            ...
            disabled={isLoading}
            className={cn(
              "flex-1 h-12 rounded-xl text-label-xs font-bold uppercase transition-all shadow-lg active:scale-95",
