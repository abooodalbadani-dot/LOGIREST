  ...
  <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
   <DialogContent className="w-[92vw] sm:w-full sm:max-w-[480px] bg-surface-container-highest border border-surface-container-high/60 shadow-2xl rounded-3xl overflow-hidden p-6 gap-6">
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
     <div className="space-y-4">
      ...
      <div className="space-y-2">
       ...
       <Input
        ...
        className="bg-card border border-border shadow-sm/40 border border-white/5 h-11 px-4 text-body-md font-bold rounded-2xl focus-visible:ring-2 focus-visible:ring-operational-cyan/20 outline-none"
       />
      </div>
      ...
      <div className="space-y-2">
       ...
       <Input
        ...
        className="bg-card border border-border shadow-sm/40 border border-white/5 h-11 px-4 text-body-md font-bold rounded-2xl focus-visible:ring-2 focus-visible:ring-operational-cyan/20 outline-none text-right"
       />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
       ...
       <div className="space-y-2">
        ...
        <Input
         ...
         placeholder="Barcode..."
         className="bg-card border border-border shadow-sm/40 border border-white/5 h-11 px-4 text-body-md font-bold rounded-2xl focus-visible:ring-2 focus-visible:ring-operational-cyan/20 outline-none font-mono"
        />
       </div>
       ...
       <div className="space-y-2">
        ...
        <Select value={derivedUomId} onValueChange={(val) => setSelectedUomId(val || null)}>
         <SelectTrigger id="uom" className="bg-card border border-border shadow-sm/40 border-none h-11 px-4 text-body-md font-bold rounded-2xl focus:ring-2 focus:ring-operational-cyan/20">
     ...
     <DialogFooter className="mt-6 flex flex-row justify-end gap-3 -mx-6 -mb-6 p-4 rounded-b-[var(--radius)] bg-card border border-border shadow-sm">
      <Button
       type="button"
       variant="ghost"
       onClick={onClose}
