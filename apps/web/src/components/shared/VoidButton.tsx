 ...
 return (
  ...
  >
   <Dialog open={isOpen} onOpenChange={setIsOpen}>
    ...
    <DialogContent className="sm:max-w-md bg-card border border-border shadow-sm border-none shadow-2xl p-8 rounded-2xl">
     ...
     <DialogFooter className="gap-3 mt-4">
      ...
      <Button
       ...
       className="flex-1 h-12 rounded-xl bg-red-500 hover:bg-red-600 text-white text-label-xs font-bold uppercase transition-all shadow-sm shadow-red-500/20 disabled:opacity-30 disabled:grayscale"
      >
       {isLoading ? (
