...
export default function PermissionDenied() {
 ...
 <div className="bg-card border border-border shadow-sm border border-transparent p-8 rounded-xl flex flex-col items-center max-w-md w-full text-center">
 ...
 <h2 className="text-headline-lg font-bold text-foreground mb-2 w-full">{t('permission_denied')}</h2>
 <p className="text-muted-foreground mb-8 w-full">{t('permission_denied_body')}</p>
 <button
 onClick={() => router.back()}
