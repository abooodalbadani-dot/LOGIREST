          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            {!isNotFound && (
              <Button
                ...
                className="gap-3 px-10 py-7 rounded-2xl border-border-muted/20 hover:bg-card border border-border shadow-sm text-muted-foreground transition-all duration-300 active:scale-95"
              >
