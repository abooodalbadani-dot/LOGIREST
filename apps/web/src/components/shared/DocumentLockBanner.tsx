...
export function DocumentLockBanner({ 
  ...
  return (
    <div className={cn(
      ...
      {isLocked && (
        <div className="hidden sm:flex items-center gap-2.5 px-4 py-2 rounded-xl bg-white/40 dark:bg-black/20 border border-white/60 dark:border-white/5 shadow-inner">
