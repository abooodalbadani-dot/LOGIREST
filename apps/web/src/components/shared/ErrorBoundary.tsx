    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-brand-black/95 p-4 overflow-y-auto select-none">
          <div className="w-full max-w-xl min-w-[280px] flex flex-col items-center justify-center p-8 md:p-12 text-center bg-card border border-border shadow-2xl rounded-2xl border border-status-error/10 animate-in fade-in zoom-in-95 duration-200">
            ...
            <p className="text-body-md text-muted-foreground/60 max-w-md mx-auto mb-8 font-medium w-full text-center leading-relaxed">
              An unexpected error occurred in the operational runtime. Diagnostic data has been logged.
            </p>
            
            <div className="flex gap-4 max-w-xs w-full justify-center">
              <button 
            ...
            {this.state.error && (
              <div className="mt-8 pt-8 border-t border-border/50 w-full select-text">
