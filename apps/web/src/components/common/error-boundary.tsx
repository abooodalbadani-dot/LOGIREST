    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-surface-container flex items-center justify-center p-8">
          <div className="max-w-md w-full bg-surface-container-low rounded-[2rem] border border-outline-low p-10 text-center space-y-6 ambient-shadow">
            ...
            <div className="flex items-center justify-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-sm bg-cyan-500/10 border border-cyan-500/30 hover:bg-cyan-500 hover:text-black transition-all text-label-sm font-semibold uppercase"
              >
