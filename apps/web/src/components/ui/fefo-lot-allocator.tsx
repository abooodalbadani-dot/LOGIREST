...
export function FEFOLotAllocator({ isOpen, onClose, itemId, requestedQty, onAllocate, lots }: FEFOLotAllocatorProps) {
 ...
 return (
  <Dialog open={isOpen} onOpenChange={onClose}>
   <DialogContent className="w-full inset-x-0 bottom-0 sm:bottom-auto mb-0 sm:mb-auto sm:max-w-2xl bg-card border border-border shadow-sm border-none p-0 overflow-hidden rounded-t-2xl rounded-b-none sm:rounded-b-2xl">
