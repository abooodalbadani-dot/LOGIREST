...
function SelectTrigger({
    ...
    const commonProps = {
        ...
        "data-size": size,
        className: cn(
            "flex items-center justify-between gap-1.5 rounded-md bg-background/50 border border-brand-gold/40 hover:border-brand-gold/70 px-4 py-2 text-sm text-text-main shadow-sm whitespace-nowrap transition-colors duration-200 outline-none select-none focus:outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold/50 backdrop-blur-sm disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-red-500 aria-invalid:focus:ring-red-500 data-placeholder:text-gray-400 dark:data-placeholder:text-muted-foreground data-[size=default]:h-10 data-[size=default]:w-full data-[size=sm]:h-8 data-[size=sm]:rounded-md data-[size=sm]:px-2.5 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
...
function SelectScrollUpButton({
    ...
    return (
        <SelectPrimitive.ScrollUpArrow
            ...
            className={cn(
                "top-0 z-10 flex w-full cursor-default items-center justify-center bg-white dark:bg-[#1A2234] border border-gray-200 dark:border-gray-800 shadow-sm py-1 [&_svg:not([class*='size-'])]:size-4",
                className
            )}
            {...props}
        >
...
function SelectScrollDownButton({
    ...
    return (
        <SelectPrimitive.ScrollDownArrow
            ...
            className={cn(
                "bottom-0 z-10 flex w-full cursor-default items-center justify-center bg-white dark:bg-[#1A2234] border border-gray-200 dark:border-gray-800 shadow-sm py-1 [&_svg:not([class*='size-'])]:size-4",
                className
            )}
            {...props}
        >
