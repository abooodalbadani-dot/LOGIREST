...
export function EmptyState({
 ...
 <div 
 className={cn(
 "flex min-h-[400px] w-full flex-col items-center justify-center rounded-xl border border-dashed bg-surface-container-low/50 p-8 text-center animate-in fade-in-50 duration-200",
 className
 )}
 {...props}
 >
