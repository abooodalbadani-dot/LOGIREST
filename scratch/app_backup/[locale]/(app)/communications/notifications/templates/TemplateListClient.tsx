  ...
  const columns: ColumnDef<NotificationTemplateRow>[] = [
    {
      ...
      header: t('code'),
      cell: ({ row }) => (
        <span dir="ltr" className="font-mono text-label-sm text-cyan-500 font-bold bg-cyan-500/5 px-2 py-0.5 rounded border border-cyan-500/10 whitespace-nowrap inline-block min-w-max">
          {row.original.code}
        </span>
      ),
    },
