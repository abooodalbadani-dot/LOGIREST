    ...
    <div className="flex flex-col space-y-2 w-full">
      <div className="relative flex items-center w-full">
        ...
        <Input
          ...
          className={cn(
            "ps-10",
            scanStatus === "error" && "border-status-error focus-visible:ring-status-error text-status-error",
            scanStatus === "success" && "border-status-success focus-visible:ring-status-success text-status-success",
            className
          )}
          {...props}
        />
