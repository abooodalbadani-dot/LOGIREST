...
export function PostConfirmDialog({
 ...
 <AlertDialogHeader>
 <AlertDialogTitle className="text-title-lg font-bold">
 {title}
 </AlertDialogTitle>
 ...
 <div className="font-bold flex items-center gap-2 text-body-md uppercase">
 <AlertTriangle className="w-4 h-4" />
 {warningText || t('warning')}
 </div>
 <div className="text-label-sm opacity-70 leading-relaxed font-medium">
 ...
 <label className="text-label-xs font-semibold text-muted-foreground uppercase ms-1">
