    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[400px] p-8 text-center bg-surface-container-low/50 backdrop-blur-xl border border-status-error/10 rounded-xl">
          ...
          <h2 className="text-xl font-display font-black text-foreground uppercase tracking-widest mb-2 italic">
            System Fault Detected
          </h2>
          <p className="text-sm text-muted-foreground/60 max-w-sm mx-auto mb-8 font-medium">
