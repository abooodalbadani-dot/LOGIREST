...
export function FilterPanel({ children, onReset }: { children: React.ReactNode; onReset: () => void }) {
  ...
  return (
    <div className="bg-surface-container-low rounded-sm mb-6 overflow-hidden">
      ...
      >
        <span className="text-xs font-bold flex items-center gap-3 uppercase tracking-widest text-primary">
      ...
      {isOpen && (
        <div className="px-6 pb-6 pt-2">
          ...
          <div className="mt-8 flex justify-end">
            <button 
              onClick={onReset}
              className="px-5 py-2 bg-surface-container-highest text-foreground hover:bg-accent transition-colors rounded-sm text-[10px] font-black uppercase tracking-[0.2em]"
            >
