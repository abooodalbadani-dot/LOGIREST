    ...
    <div className="hidden print:flex flex-col gap-6 mb-10 border-b border-surface-variant/20 pb-8 animate-in fade-in duration-500">
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-muted-foreground whitespace-pre-wrap max-w-lg leading-relaxed">
            {profile.address}
          </p>
        </div>
      ...
      <div className={cn(
        "grid grid-cols-2 md:grid-cols-4 gap-4 text-[10px] font-black uppercase text-muted-foreground/60 tracking-wider",
