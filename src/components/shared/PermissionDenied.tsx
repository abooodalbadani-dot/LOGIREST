  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh]">
      <div className="bg-surface-1 border border-surface-3 p-8 rounded-lg shadow-lg flex flex-col items-center max-w-md w-full text-center">
        ...
        <button
          onClick={() => router.back()}
          className="bg-surface-3 hover:bg-surface-2 text-on-surface px-6 py-2 rounded transition-colors flex items-center gap-2 border border-transparent focus:border-cyan-500 outline-none"
        >
