export const inventoryMocks: Record<string, unknown> = {
 ...
 { item_id: 'item-4', item_code: 'ITM-004', item_name_ar: 'أرز بسمتي', item_name_en: 'Basmati Rice', warehouse_id: 'wh-1', warehouse_name_ar: 'المستودع الرئيسي', warehouse_name_en: 'Main Warehouse', qty_on_hand: 500, qty_reserved: 100, qty_available: 400, reorder_point: 200 },
 { item_id: 'item-5', item_code: 'ITM-005', item_name_ar: 'سكر ناعم', item_name_en: 'Sugar', warehouse_id: 'wh-1', warehouse_name_ar: 'المستودع الرئيسي', warehouse_name_en: 'Main Warehouse', qty_on_hand: 15, qty_reserved: 5, qty_available: 10, reorder_point: 40 },
 ],
 ...
 { id: 'lot-2', item_id: 'item-1', item_code: 'ITM-001', item_name_ar: 'لحم بقر', item_name_en: 'Beef', lot_number: 'LOT-2025-A2', expiry_date: '2025-12-15', qty_available: 25, is_expired: false, is_near_expiry: false },
 ...
 { id: 'lot-7', item_id: 'item-4', item_code: 'ITM-004', item_name_ar: 'أرز بسمتي', item_name_en: 'Basmati Rice', lot_number: 'LOT-2026-E1', expiry_date: '2024-05-10', qty_available: 150, is_expired: true, is_near_expiry: false },
 { id: 'lot-8', item_id: 'item-5', item_code: 'ITM-005', item_name_ar: 'سكر ناعم', item_name_en: 'Sugar', lot_number: 'LOT-2026-F1', expiry_date: '2026-04-28', qty_available: 10, is_expired: false, is_near_expiry: true },
 ],
 meta: { page: 1, page_size: 10, total: 8, total_pages: 1 }
 },
 ...
 { id: 'mv-10', posted_at: '2026-04-14T12:00:00Z', document_id: 'adj-1', document_number: 'ADJ-2026-001', document_type: 'ADJUSTMENT', item_id: 'item-1', item_code: 'ITM-001', item_name_ar: 'لحم بقر', item_name_en: 'Beef', lot_number: 'LOT-2025-A1', direction: 'OUT', qty: 5 },
 { id: 'mv-11', posted_at: '2026-04-13T10:30:00Z', document_id: 'adj-2', document_number: 'ADJ-2026-002', document_type: 'ADJUSTMENT', item_id: 'item-4', item_code: 'ITM-004', item_name_ar: 'أرز بسمتي', item_name_en: 'Basmati Rice', lot_number: 'LOT-2026-E1', direction: 'OUT', qty: 50 },
 ],
 meta: { page: 1, page_size: 10, total: 11, total_pages: 1 }
 }
};
