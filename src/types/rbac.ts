...
export const PERMISSION_MATRIX: PermissionMatrix = {
  ...
  APPROVER:     { grn: ['view'], pr: ['view','approve'], po: ['view','approve'], issue: ['view'], transfer: ['view'], adjustment: ['view','approve'], stocktake: ['view','approve'], inventory: ['view'], reports: ['view'] },
  ...
  VIEWER:       { grn: ['view'], pr: ['view'], po: ['view'], issue: ['view'], transfer: ['view'], adjustment: ['view'], stocktake: ['view'], inventory: ['view'], reports: ['view'] },
};
