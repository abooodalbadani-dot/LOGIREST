...
export function IssueScanClient() {
  ...
  const borderClass =
    lastFeedback === "success"
      ...
      : lastFeedback === "error"
      ? "border-neon-error shadow-[0_0_15px_rgba(255,180,171,0.4)]"
      : "border-surface-2";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className={`relative border-2 rounded-xl p-5 transition-all duration-200 ${borderClass}`}>
        ...
        {lastFeedback === "error" && (
          <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-1 text-neon-error text-sm font-bold animate-pulse">
              ...
              {lines.map((line) => (
                <div
                  ...
                  className={`flex items-center justify-between p-3 rounded-lg border text-sm ${
                    line.isExpired ? "bg-neon-error/5 border-neon-error/30" : "bg-surface-2/40 border-surface-2"
                  }`}
                >
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2">
                      ...
                      {line.isExpired && (
                        <span className="text-xs text-neon-error font-bold flex items-center gap-1">
