          ...
          <Card className="bg-surface-container-low border-none overflow-hidden">
            <CardContent className="p-8 space-y-8">
              <div className="flex items-center gap-3 pb-4 border-b border-surface-variant/10">
                ...
                <div>
                  <h3 className="text-sm font-semibold tracking-[0.08em] text-foreground uppercase">{t('basic_info')}</h3>
                  <p className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-[0.08em] mt-0.5">{tu('description')}</p>
                </div>
              </div>

              <div className="space-y-6">
                <div className="space-y-2 max-w-sm">
                  <Label htmlFor="uom-code" className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/70">{t('code')}</Label>
                  <Controller
                    name="code"
                    control={control}
                    render={({ field }) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <Label htmlFor="uom-name-en" className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/70">{t('name_en')}</Label>
                    <Input 
                      id="uom-name-en" 
                      dir="ltr" 
                      {...register('name_en')} 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="uom-name-ar" className="text-[10px] font-semibold uppercase tracking-normal text-muted-foreground/70">{t('name_ar')}</Label>
                    <Input 
                      id="uom-name-ar" 
                      dir="rtl" 
                      {...register('name_ar')} 
            ...
            <CardContent className="p-8 space-y-6">
              <div className="flex items-center gap-3 pb-4 border-b border-surface-variant/10">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-[0.08em] mt-0.5">{t('status')}</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-surface-container-highest/20 rounded-md border border-surface-variant/10 group transition-all hover:bg-surface-container-highest/30">
                <div className="space-y-1">
                  <Label htmlFor="uom-active" className="text-[10px] font-semibold uppercase tracking-[0.08em] cursor-pointer text-muted-foreground/60">{t('is_active')}</Label>
              ...
              <div className="p-4 bg-amber-500/5 rounded-md border border-amber-500/10 border-dashed">
                <div className="flex items-center gap-2 mb-2 text-amber-500">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest">{tu('precision')}</span>
                </div>
                <p className="text-[10px] text-muted-foreground/50 uppercase tracking-widest font-medium leading-relaxed">
