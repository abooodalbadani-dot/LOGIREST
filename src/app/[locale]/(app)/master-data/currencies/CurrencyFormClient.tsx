...
import { Landmark, Type, Coins, Activity, Info, ShieldCheck } from 'lucide-react';
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  <Label htmlFor="curr-code" className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/70">
                    {t('fields.code')}
                  </Label>
                  <div className="relative group">
                    ...
                    <Input 
                      ...
                      maxLength={3}
                      {...register('code')} 
                      className="h-11 ps-10 border-none bg-surface-container-high/40 focus:bg-surface-container-high transition-colors font-mono font-bold text-xs uppercase tracking-widest text-cyan-500"
                    />
                  </div>
                  {errors.code && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.code.message as any)}</p>}
                </div>

                {/* Symbol Field */}
                <div className="space-y-2">
                  <Label htmlFor="curr-symbol" className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/70">
                    {t('fields.symbol')}
                  </Label>
                  <div className="relative group">
                    ...
                    <Input 
                      ...
                      placeholder="e.g. SR"
                      {...register('symbol')} 
                      className="h-11 ps-10 border-none bg-surface-container-high/40 focus:bg-surface-container-high transition-colors font-mono font-bold text-xs text-amber-500"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Name EN */}
                <div className="space-y-2">
                  <Label htmlFor="curr-name-en" className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/70">
                    {t('fields.name_en')}
                  </Label>
                  <Input 
                    id="curr-name-en" 
                    {...register('name_en')} 
                    className="h-11 border-none bg-surface-container-high/40 focus:bg-surface-container-high transition-colors text-xs font-bold"
                  />
                  {errors.name_en && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.name_en.message as any)}</p>}
                </div>

                {/* Name AR */}
                <div className="space-y-2">
                  <Label htmlFor="curr-name-ar" className="text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/70">
                    {t('fields.name_ar')}
                  </Label>
                  <Input 
                    id="curr-name-ar" 
                    ...
                    className="h-11 border-none bg-surface-container-high/40 focus:bg-surface-container-high transition-colors text-xs font-bold"
                  />
                  {errors.name_ar && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.name_ar.message as any)}</p>}
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8 space-y-6">
              <div className="flex items-center gap-3 pb-4 border-b border-surface-variant/10">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-[0.08em] mt-0.5">Financial Controls</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-amber-500/5 rounded-md border border-amber-500/10">
                <div className="space-y-0.5">
                  <Label className="text-[10px] font-bold uppercase tracking-[0.08em] text-foreground/80">{t('fields.is_base')}</Label>
                  <p className="text-[9px] text-muted-foreground uppercase font-medium">System valuation anchor</p>
                </div>
                <Controller
              ...
              <div className="flex items-center justify-between p-4 bg-surface-container-highest/10 rounded-md border border-surface-variant/5">
                <div className="space-y-0.5">
                  <Label className="text-[10px] font-bold uppercase tracking-[0.08em] text-foreground/80">{t('fields.is_active')}</Label>
                  <p className="text-[9px] text-muted-foreground uppercase font-medium">Operationally available</p>
                </div>
                <Controller
                  name="is_active"
                  control={control}
          ...
          <Card className="bg-surface-container-low border-none rounded-md overflow-hidden">
            <CardContent className="p-8 space-y-6">
              <div className="flex items-center gap-3 pb-4 border-b border-surface-variant/10">
                ...
                <div>
                  <h3 className="text-sm font-semibold tracking-tight text-foreground uppercase">Standards</h3>
                  <p className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-[0.08em] mt-0.5">Regulatory compliance</p>
                </div>
              </div>
