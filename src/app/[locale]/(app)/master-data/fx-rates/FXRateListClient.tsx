        ...
        return (
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5">
              <span dir="ltr" className="font-mono text-[11px] font-black text-cyan-500 bg-cyan-500/5 px-2 py-0.5 rounded-sm">
                {from?.code || '---'}
              </span>
              <ArrowRightLeft className="w-3 h-3 text-muted-foreground/30" />
              <span dir="ltr" className="font-mono text-[11px] font-black text-amber-500 bg-amber-500/5 px-2 py-0.5 rounded-sm">
                {to?.code || '---'}
              </span>
            </div>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex flex-col gap-0.5">
          <span dir="ltr" className="font-mono text-[13px] font-black text-foreground tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 opacity-60 hover:opacity-100 transition-opacity duration-500 pb-10 pt-4 border-t border-surface-variant/5">
        <div className="p-6 bg-surface-container-low/50 rounded-sm border border-white/5 flex items-start gap-4">
          ...
          <div className="space-y-1">
            <h4 className="text-[10px] font-black uppercase tracking-[0.1em] text-emerald-500">{t('tips.precision_title')}</h4>
        ...
        <div className="p-6 bg-surface-container-low/50 rounded-sm border border-white/5 flex items-start gap-4">
          ...
          <div className="space-y-1">
            <h4 className="text-[10px] font-black uppercase tracking-[0.1em] text-cyan-500">{t('tips.temporal_integrity_title')}</h4>
            <p className="text-[10px] text-muted-foreground font-semibold leading-relaxed uppercase tracking-tight">
