            ...
            <CardContent className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.from_currency_id && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.from_currency_id.message as any)}</p>}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.to_currency_id && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.to_currency_id.message as any)}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input 
                      ...
                      className="h-11 ps-10 border-none bg-surface-container-high/40 focus:bg-surface-container-high transition-colors font-mono font-bold text-xs tracking-tight"
                    />
                  </div>
                  {errors.rate && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.rate.message as any)}</p>}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.effective_date && <p className="text-[10px] font-semibold text-rose-400 uppercase tracking-tight">{t(errors.effective_date.message as any)}</p>}
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-surface-container-low border-none rounded-md overflow-hidden">
            <CardContent className="p-8 space-y-6">
              <div className="flex items-center gap-3 pb-4 border-b border-surface-variant/10">
                ...
                <div>
                  <h3 className="text-sm font-semibold tracking-tight text-foreground uppercase">Financial Rules</h3>
                  <p className="text-[10px] font-semibold text-muted-foreground/60 uppercase tracking-[0.08em] mt-0.5">Audit Standard</p>
                </div>
              </div>
