...
export function UserFormClient({ id, createTitle, editTitle, locale }: Props) {
 ...
 <select
 {...register('language')}
 className="h-11 px-4 bg-surface-container-highest/30 border border-outline-low rounded-sm w-full text-label-sm font-bold focus:outline-none focus:ring-1 focus:ring-cyan-500/50"
 >
