            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="space-y-4">
                <div className="flex items-center justify-between px-1">
                  <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground/60/70">
                    {t('expiry_control')}
                  </h4>
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20">
        ...
        actions={
          <div className="flex items-center gap-4 bg-surface-container-low p-4 rounded-xl border border-surface-container-high/20 shadow-sm">
            <div className="flex flex-col gap-1 pe-4 border-e border-surface-container-high/50">
              <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60/60 flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-bold text-foreground">98.4%</span>
              </div>
            </div>
            
            <div className="flex flex-col gap-0.5">
              <div className="flex items-center gap-2">
                 <Badge variant="outline" className="bg-status-success/10 text-status-success border-status-success/20 text-[9px] font-black h-5 px-1.5 uppercase tracking-tighter">
              ...
              <div className="flex items-center gap-3 mt-1">
                 <div className="flex items-center gap-1.5">
                   ...
                   <span className="text-[10px] font-bold text-muted-foreground/60/60">Backup: {stats.lastBackup}</span>
                 </div>
                 <div className="flex items-center gap-1.5">
                   <Users className="w-3 h-3 text-muted-foreground/60/40" />
                   <span className="text-[10px] font-bold text-muted-foreground/60/60">{stats.activeUsers} Users Online</span>
                 </div>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-4 pt-6">
        <div className="flex items-center justify-between px-1">
          <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground/60/40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 opacity-30 grayscale pointer-events-none filter blur-[0.5px] transition-all hover:opacity-100 hover:grayscale-0 hover:blur-0">
           <div className="lg:col-span-2 h-56 rounded-2xl bg-surface-container-low border border-dashed border-surface-container-high flex flex-col items-center justify-center gap-4">
              ...
              <span className="text-muted-foreground/60 italic text-[10px] font-black tracking-widest uppercase">Movement Analytics (Phase 12)</span>
           </div>
           <div className="h-56 rounded-2xl bg-surface-container-low border border-dashed border-surface-container-high flex flex-col items-center justify-center gap-4">
              <Activity className="w-8 h-8 text-muted-foreground/60/20" />
              <span className="text-muted-foreground/60 italic text-[10px] font-black tracking-widest uppercase">Audit Logs</span>
           </div>
        </div>
      </div>
    </div>
