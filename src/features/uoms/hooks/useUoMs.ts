...
import { type UoM, type UoMFormValues, type Item } from '@/types/master-data';

const QUERY_KEY = ['uoms'];

const INITIAL_UOMS: UoM[] = [
  { id: 'UOM-001', code: 'KG', name_en: 'Kilogram', name_ar: 'كيلو جرام', is_active: true },
  { id: 'UOM-002', code: 'L', name_en: 'Liter', name_ar: 'لتر', is_active: true },
  { id: 'UOM-003', code: 'PCS', name_en: 'Piece', name_ar: 'حبة', is_active: true },
  { id: 'UOM-004', code: 'BOX', name_en: 'Box', name_ar: 'صندوق', is_active: true },
  { id: 'UOM-005', code: 'PKT', name_en: 'Packet', name_ar: 'باكيت', is_active: false },
];
