  ...
  return (
    <div className="p-8 max-w-[1000px] mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-12">
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[10px] text-muted-foreground/40 uppercase tracking-[0.08em] font-medium">Read-Only Asset Intelligence</p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between pt-6 px-8 py-6 bg-surface-container-low/30 rounded-lg">
        <span className="text-[10px] text-muted-foreground/40 uppercase tracking-[0.08em] font-medium">Operational Snapshot</span>
        <div className="flex gap-4 items-center">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-status-active" />
            <span className="text-[9px] text-status-active/60 font-semibold uppercase tracking-tighter">Verified Static Data</span>
          </div>
        </div>
      </div>
    </div>
