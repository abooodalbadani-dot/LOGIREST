        ...
        <div className="lg:col-span-1 space-y-8">
          <Card className="bg-surface-container-low border-white/10-muted/20 shadow-2xl overflow-hidden relative group">
            ...
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl font-black tracking-tighter uppercase italic">{stats.systemHealth}% {t('system_health.health_suffix')}</CardTitle>
              <CardDescription className="text-[10px] font-medium text-muted-foreground/60 uppercase tracking-widest">{t('system_health.node_description')}</CardDescription>
            </CardHeader>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors group cursor-pointer">
                    <div className="flex flex-col gap-0.5">
                      <span className="text-[11px] font-bold text-foreground group-hover:text-operational-cyan transition-colors">{log.action}</span>
                      <span className="text-[9px] font-medium text-muted-foreground/40">{log.user}</span>
                    </div>
                    <span className="text-[9px] font-black text-muted-foreground/30 uppercase tracking-tighter font-mono">{log.time}</span>
                  </div>
                ))}
              </div>
            </CardContent>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="bg-surface-container-low border-white/10-muted/20 shadow-2xl relative overflow-hidden">
             ...
             <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div>
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-operational-cyan mb-1 block">{t('analytics.title')}</span>
