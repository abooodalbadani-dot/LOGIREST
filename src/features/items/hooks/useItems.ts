...
const INITIAL_ITEMS: Item[] = [
  {
    ...
    category_id: 'CAT-001',
    primary_uom: { id: 'UOM-001', code: 'PCS', name_en: 'Piece', name_ar: 'حبة' },
    uom_conversions: [],
    track_lots: true,
    min_stock_level: 50,
    reorder_point: 100,
  ...
  },
  {
    ...
    category_id: 'CAT-001',
    primary_uom: { id: 'UOM-002', code: 'L', name_en: 'Liter', name_ar: 'لتر' },
    uom_conversions: [],
    track_lots: false,
    min_stock_level: 20,
    reorder_point: 40,
  ...
  },
  {
    ...
    category_id: 'CAT-002',
    primary_uom: { id: 'UOM-003', code: 'PCS', name_en: 'Piece', name_ar: 'حبة' },
    uom_conversions: [],
    track_lots: false,
    min_stock_level: 5,
    reorder_point: 10,
